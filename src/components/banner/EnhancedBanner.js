            ...
            <AnimatedSection animation="fade-up" className="flex flex-col gap-8 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col gap-3 text-center">
                    ...
                    <p className="text-base-plus md:text-lg text-gray-300 font-medium mx-auto mt-2 max-w-prose leading-relaxed text-justify">
                        Hi, I’m Christo, a data analyst with an engineering background and a strong drive for problem-solving. I love technology in general and enjoy building things—but let’s focus on data analysis here. I use various tools to transform complex data into clear insights that support decision-making.
